...
+ "</center>\n" + 
" <img style=\"border-radius: 5px 5px 0 0;width:40%;margin-left:250px;\" "
+ "src=\"https://media.istockphoto.com/photos/airbus-a320-aeroplane-picture-id171264813?k=20&m=171264813&s=612x612&w=0&h=oyM2EKEbauYWxiHH1j0xiHVdKkYLpdXJXnOuRT9P2_w=\" alt=\"Avatar\">\n" + 
...
"<h4><b> BOOKING DATE - "+ss.getAttribute("userdate")+"</b></h4>"+
"<h4><b> BOOKED FOR - "+ss.getAttribute("numberofpeople")+"PEOPLE"+"</b></h4>"+
