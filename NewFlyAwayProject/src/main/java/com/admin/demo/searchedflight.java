...
@WebServlet("/avflights")
public class searchedflight  extends HttpServlet{ 
...
out.print("<a href="+"useroptions1.html"+">Proceed to Login to Book  </a><br><br>");
out.print("<a href="+"search.html"+">Go Back to Search for Another Date</a>");
} 
//if flight is unavailable on that day 
else { 
out.print("<h4 style='color:red'>No Flights for selected date</h4>"); 
out.print("<a href="+"search.html"+">Go Back to Search for Another Flight</a>");
} 
//3. close session 
session.close(); 
} catch (Exception e) { 
